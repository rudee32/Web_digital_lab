...
var isReactNative2 = !isNode && typeof document === "undefined";
var generateUuid = () => {
...
var createAnalyticsModule = ({ axiosClient, serverUrl, appId, userAuthModule }) => {
  ...
  if (!((_a = analyticsSharedState.config) === null || _a === void 0 ? void 0 : _a.enabled) || isReactNative2) {
    return {
      track: () => {
      },
      cleanup: () => {
...
//# sourceMappingURL=chunk-PJR2J3ZH.js.map
